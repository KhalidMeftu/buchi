  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) =>
              sLocator<PetsListBloc>()..add(GetPetsListEvent()),
        ),
                          ...
                          return Column(
                            children: [
                              HomePageLivePetsList(
                                imageUrl:
                                    state.petsList[index].photos.length > 1
                                        ? state.petsList[index].photos[0].url
                                            .toString()
                                        : '',

                                /// i only need one image
                                petCategory:
                                    state.petsList[index].type.toString(),
                                onTap: () {
                                  Navigator.pushNamed(
                                      ...
                                      arguments: [
                                        ...
                                        state
                                            .petsList[index].good_with_children,
